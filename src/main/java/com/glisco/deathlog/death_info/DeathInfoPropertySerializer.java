...
public class DeathInfoPropertySerializer {
    ...
    public static NbtCompound save(DeathInfoProperty property, String identifier) {
        return save(property, identifier, null);
    }

    public static NbtCompound save(DeathInfoProperty property, String identifier, RegistryWrapper.WrapperLookup registries) {
        NbtCompound nbt = new NbtCompound();
        nbt.putString("Type", property.getType().getId());
        nbt.putString("Identifier", identifier);
        property.writeNbt(nbt, registries);
        return nbt;
    }

    public static Pair<DeathInfoProperty, String> load(NbtCompound propertyNbt) {
        return load(propertyNbt, null);
    }

    public static Pair<DeathInfoProperty, String> load(NbtCompound propertyNbt, RegistryWrapper.WrapperLookup registries) {
        ...
        return new Pair<>(typeInstance.readFromNbt(propertyNbt, registries), identifier);
    }
